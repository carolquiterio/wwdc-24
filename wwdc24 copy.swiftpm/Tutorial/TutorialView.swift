...
struct TutorialView: View {
    ...
    let tutorials: [Tutorial] = [
        ...
        Tutorial(text: "Picture this – your eye has 3 color cones, but 2 of them get a little confused due to a genetic mutation in the retina.", imageName: "GreenAndEyeCones", invertBalloon: false),
        ...
        Tutorial(text: "OOOOps, I think I have an idea! What if we created a machine to transform colors into shapes?", imageName: "GreenHasIdeaWithShapes", invertBalloon: false),
        Tutorial(text: "Wow! That would be amazing!", imageName: "RedHappyWithShaped", invertBalloon: false)
    ]
